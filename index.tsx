...
const AISummarizerIcon: React.FC<{ width?: number; height?: number }> = ({
  width = 24,
  height = 24,
}) => (
...
const Dismiss: React.FC<{ onDismiss: () => void }> = ({ onDismiss }) => (
  <button onClick={onDismiss} className="vc-ai-summarizer-dismiss">
    Dismiss
  </button>
);
...
export default definePlugin({
  ...
  async start() {
    ...
    addAccessory("vc-ai-summarizer", (props) => (
      <SummaryAccessory message={props.message} />
    ));
